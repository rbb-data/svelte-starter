const __resolved__virtual_storySource_srcLibComponentsLayercakePathStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsLayercakePathStorySvelte as default
};
