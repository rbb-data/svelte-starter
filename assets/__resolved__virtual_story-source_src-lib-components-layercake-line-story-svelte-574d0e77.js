const __resolved__virtual_storySource_srcLibComponentsLayercakeLineStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsLayercakeLineStorySvelte as default
};
