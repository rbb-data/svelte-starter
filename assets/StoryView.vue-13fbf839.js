...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const sizeTooltip = computed(() => {
      var _a, _b;
      return ((_a = responsiveWidth.value) != null ? _a : "Auto") + " × " + ((_b = responsiveHeight.value) != null ? _b : "Auto");
    });
    return (_ctx, _cache) => {
...
const markdownFiles = reactive({ "src/lib/components/Introduction.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-introduction-story-md-5aad9911.js"), true ? [] : void 0), "src/lib/components/shared/ChartFooter.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-chartfooter-story-md-1aac4260.js"), true ? [] : void 0), "src/lib/components/shared/Button.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-button-story-md-08144fec.js"), true ? [] : void 0), "src/lib/components/shared/ChartHeader.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-chartheader-story-md-488bddd6.js"), true ? [] : void 0), "src/lib/components/shared/ChartLegend.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-chartlegend-story-md-4190b7f5.js"), true ? [] : void 0), "src/lib/components/shared/RadioButtons.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-radiobuttons-story-md-7cda79bd.js"), true ? [] : void 0), "src/lib/components/shared/Search.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-search-story-md-2dfbcbba.js"), true ? [] : void 0), "src/lib/components/shared/CheckBoxes.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-checkboxes-story-md-ca248f08.js"), true ? [] : void 0), "src/lib/components/shared/Dropdown.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-dropdown-story-md-54d1569c.js"), true ? [] : void 0), "src/lib/components/shared/Slant.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-slant-story-md-f7acfe79.js"), true ? [] : void 0), "src/lib/components/shared/Tabs.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-tabs-story-md-4c0e3109.js"), true ? [] : void 0), "src/lib/components/shared/Select.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-select-story-md-59be9dff.js"), true ? [] : void 0), "src/lib/components/shared/Table.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-table-story-md-940aa5cd.js"), true ? [] : void 0), "src/lib/components/shared/TabPanels.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-shared-tabpanels-story-md-bd6ee317.js"), true ? [] : void 0), "src/lib/components/layercake/Arrow.story.md": () => __vitePreload(() => import("./__resolved__virtual_md_src-lib-components-layercake-arrow-story-md-1653f8ce.js"), true ? [] : void 0) });
