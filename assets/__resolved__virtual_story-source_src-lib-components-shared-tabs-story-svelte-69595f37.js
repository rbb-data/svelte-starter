const __resolved__virtual_storySource_srcLibComponentsSharedTabsStorySvelte = `<script lang="ts">
...
<Hst.Story group="ui" title="Tabs" layout={{ type: 'grid', width: '100%' }}>
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsSharedTabsStorySvelte as default
};
