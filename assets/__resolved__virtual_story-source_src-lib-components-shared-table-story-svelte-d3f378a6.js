const __resolved__virtual_storySource_srcLibComponentsSharedTableStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsSharedTableStorySvelte as default
};
