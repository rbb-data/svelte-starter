const __resolved__virtual_storySource_srcLibComponentsSharedTabpanelsStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsSharedTabpanelsStorySvelte as default
};
