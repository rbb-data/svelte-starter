const __resolved__virtual_storySource_srcLibComponentsLayercakeAxisxStorySvelte = `<script lang="ts">
...
>
  <Hst.Variant title="Basic">
    <div class="layercake">
      ...
      >
        <Svg>
          <AxisX {showDomainLine} {showGridLines} {showTickLines} />
        </Svg>
      </LayerCake>
    </div>
  </Hst.Variant>

  <Hst.Variant title="On top">
    <div class="layercake">
      <LayerCake
        {data}
        padding={{ top: 24, right: 12, bottom: 24, left: 12 }}
      ...
      >
        <Svg>
          <AxisX {showDomainLine} {showGridLines} {showTickLines} onTop />
        </Svg>
      </LayerCake>
    </div>
  </Hst.Variant>
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsLayercakeAxisxStorySvelte as default
};
