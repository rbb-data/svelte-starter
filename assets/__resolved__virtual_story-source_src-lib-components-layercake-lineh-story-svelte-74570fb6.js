const __resolved__virtual_storySource_srcLibComponentsLayercakeLinehStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsLayercakeLinehStorySvelte as default
};
