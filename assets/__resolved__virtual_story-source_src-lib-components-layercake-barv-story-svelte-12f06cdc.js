const __resolved__virtual_storySource_srcLibComponentsLayercakeBarvStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsLayercakeBarvStorySvelte as default
};
