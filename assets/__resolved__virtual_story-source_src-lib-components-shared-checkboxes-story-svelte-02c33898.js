const __resolved__virtual_storySource_srcLibComponentsSharedCheckboxesStorySvelte = `<script lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcLibComponentsSharedCheckboxesStorySvelte as default
};
