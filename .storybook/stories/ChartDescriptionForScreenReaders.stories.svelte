...
<Story name="Basic">
  <i>
    Nothing to see here as chart descriptions for screen readers are visually
    hidden. See below for a story in debug mode that renders the description
    provided to a screen reader.
  </i>
